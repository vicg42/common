...
add wave -noupdate -radix unsigned -childformat {{/vtest_gen_tb/uut/i_vd(0) -radix unsigned}} -subitemconfig {/vtest_gen_tb/uut/i_vd(0) {-height 15 -radix unsigned}} /vtest_gen_tb/uut/i_vd
...
add wave -noupdate /vtest_gen_tb/i_vs_edge
add wave -noupdate /vtest_gen_tb/i_hs_edge
...
add wave -noupdate -radix hexadecimal /vtest_gen_tb/i_sdi_txd
...
update
WaveRestoreZoom {164315761 ps} {168270321 ps}
