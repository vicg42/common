...
add wave -noupdate -color {Slate Blue} -itemcolor Gold -radix unsigned /scaler_bilinear_tb/dbg_cntx_i
add wave -noupdate -color {Slate Blue} -itemcolor Gold -radix unsigned /scaler_bilinear_tb/dbg_cnty_i
add wave -noupdate /scaler_bilinear_tb/di_i
...
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_h_m/new_pix
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_h_m/sof
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_h_m/new_fr
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_h_m/sol
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_h_m/new_line
...
add wave -noupdate -radix unsigned /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/scale_step
add wave -noupdate -radix unsigned -childformat {{{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[5]} -radix unsigned} {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[4]} -radix unsigned} {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[3]} -radix unsigned} {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[2]} -radix unsigned} {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[1]} -radix unsigned} {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[0]} -radix unsigned}} -subitemconfig {{/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[5]} {-height 15 -radix unsigned} {/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[4]} {-height 15 -radix unsigned} {/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[3]} {-height 15 -radix unsigned} {/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[2]} {-height 15 -radix unsigned} {/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[1]} {-height 15 -radix unsigned} {/scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy[0]} {-height 15 -radix unsigned}} /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/dy
...
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/buf_wsel
add wave -noupdate -color {Slate Blue} -itemcolor Gold /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/fsm_cs
add wave -noupdate -radix unsigned /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/cnt_o
add wave -noupdate -radix unsigned /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/buf_rcnt
add wave -noupdate -radix unsigned /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/cnt_sparse
add wave -noupdate -expand /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/buf_do
...
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/do_o
add wave -noupdate -expand /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/sr_de_o_early
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/sr_hs_o_early
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/sr_vs_o_early
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/do_o
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/de_o
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/hs_o
add wave -noupdate /scaler_bilinear_tb/scaler_belinear_m/scaler_linear_v_m/vs_o
add wave -noupdate -divider {output monitor}
add wave -noupdate -color {Slate Blue} -itemcolor Gold -radix unsigned /scaler_bilinear_tb/monitor_m/xcnt
add wave -noupdate -color {Slate Blue} -itemcolor Gold -radix unsigned /scaler_bilinear_tb/monitor_m/ycnt
add wave -noupdate -radix unsigned /scaler_bilinear_tb/monitor_m/frcnt
add wave -noupdate -radix unsigned /scaler_bilinear_tb/monitor_m/wen
add wave -noupdate /scaler_bilinear_tb/monitor_m/di
add wave -noupdate /scaler_bilinear_tb/monitor_m/de
add wave -noupdate /scaler_bilinear_tb/monitor_m/hs
add wave -noupdate /scaler_bilinear_tb/monitor_m/vs
