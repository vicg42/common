...
add wave -noupdate /scaler_h_tb/scaler_h_m/TABLE_INPUT_WIDTH_MASK
...
add wave -noupdate -divider {New Divider}
add wave -noupdate /scaler_h_tb/scaler_h_m/cubic_table_m/dx
add wave -noupdate /scaler_h_tb/scaler_h_m/cubic_table_m/f0
add wave -noupdate /scaler_h_tb/scaler_h_m/cubic_table_m/f1
add wave -noupdate /scaler_h_tb/scaler_h_m/cubic_table_m/f2
add wave -noupdate /scaler_h_tb/scaler_h_m/cubic_table_m/f3
add wave -noupdate /scaler_h_tb/scale_step_h
add wave -noupdate /scaler_h_tb/scaler_h_m/cnt_i_23_12
...
add wave -noupdate /scaler_h_tb/scaler_h_m/cnt_o_23_12
...
add wave -noupdate -divider {New Divider}
add wave -noupdate -radix unsigned /scaler_h_tb/scaler_h_m/do_o
...
update
WaveRestoreZoom {2856151 ps} {3007572 ps}
