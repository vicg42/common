...
add wave -noupdate {/scaler_cubic_h_tb/scaler_cubic_h_m/sr_di_i[0]}
add wave -noupdate {/scaler_cubic_h_tb/scaler_cubic_h_m/sr_di_i[1]}
add wave -noupdate {/scaler_cubic_h_tb/scaler_cubic_h_m/sr_di_i[2]}
add wave -noupdate {/scaler_cubic_h_tb/scaler_cubic_h_m/sr_di_i[3]}
...
update
WaveRestoreZoom {998965 ps} {1022290 ps}
