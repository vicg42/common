...
add wave -noupdate -radix hexadecimal -childformat {{/prog_flash_tb/pout_phy.a -radix hexadecimal} {/prog_flash_tb/pout_phy.oe_n -radix hexadecimal} {/prog_flash_tb/pout_phy.we_n -radix hexadecimal} {/prog_flash_tb/pout_phy.cs_n -radix hexadecimal} {/prog_flash_tb/pout_phy.rst_n -radix hexadecimal} {/prog_flash_tb/pout_phy.adv_n -radix hexadecimal}} -subitemconfig {/prog_flash_tb/pout_phy.a {-height 15 -radix hexadecimal} /prog_flash_tb/pout_phy.oe_n {-height 15 -radix hexadecimal} /prog_flash_tb/pout_phy.we_n {-height 15 -radix hexadecimal} /prog_flash_tb/pout_phy.cs_n {-height 15 -radix hexadecimal} /prog_flash_tb/pout_phy.rst_n {-height 15 -radix hexadecimal} /prog_flash_tb/pout_phy.adv_n {-height 15 -radix hexadecimal}} /prog_flash_tb/pout_phy
add wave -noupdate /prog_flash_tb/m_core/p_out_status
