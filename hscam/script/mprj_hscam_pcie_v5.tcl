...
set _usrdef_ucf_filename "hscam_pcie_v5"
set _usrdef_ucf_filepath "..\ucf\hscam_pcie_v5.ucf"
...
set _projects [ list \
  [ list \
    $_usrdef_xilinx_family $_usrdef_device $_usrdef_pkg $_usrdef_speed xrc5t1 [ list \
      ...
      [ list "../src/core_gen/v5/bram_dma_params.vhd" $_VHDMod ] \
      [ list "../src/core_gen/v5/pcie2mem_fifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/v5/cfgdev_2txfifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/v5/cfgdev_rxfifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/use_newinterrupt.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_if.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll_tx.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll_tx_arb.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_plus_ll_tx.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_plus_ll_rx.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tlm_rx_data_snk.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tlm_rx_data_snk_mal.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tlm_rx_data_snk_bar.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tlm_rx_data_snk_pwr_mgmt.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_decoder.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll_oqbqfifo.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll_arb.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_ll_credit.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_cf.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_cf_mgmt.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_cf_err.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_cf_pwr.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_blk_cf_arb.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_cnt_en.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_cnt_nfl_en.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_cor.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_cpl.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_ftl.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_nfl.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_ram4x26.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_errman_ram8x26.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/cmm_intr.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_soft_int.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/bram_common.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_clocking.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tx_sync_gtx.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/tx_sync_gtp.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_gtx_wrapper.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_gt_wrapper.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_gt_wrapper_top.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_mim_wrapper.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_reset_logic.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_top.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/prod_fixes.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/sync_fifo.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/extend_clk.v" $_VMod ] \
      [ list "../src/core_gen/v5/core_pciexp_ep_blk_plus/source/pcie_ep.v" $_VMod ] \
      ...
      [ list "../../ucf/hscam_pcie_v5.ucf" "hscam_pcie_main" ] \
    ] \
  ] \
]
