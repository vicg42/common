...
set _usrdef_ucf_filename "hdd_vm_main"
set _usrdef_ucf_filepath "..\ucf\hdd_vm_main.ucf"
...
set _projects [ list \
  [ list \
    $_usrdef_xilinx_family $_usrdef_device $_usrdef_pkg $_usrdef_speed xrc5t1 [ list \
      ...
      [ list "../src/hdd/veresk_pkg.vhd" $_VHDPkg ] \
      [ list "../../../common/video_pkt_filter.vhd" $_VHDMod ] \
      [ list "../../../common/dsn_timer.vhd" $_VHDMod ] \
      [ list "../src/hdd/dsn_switch.vhd" $_VHDMod ] \
      [ list "../../../common/dsn_host.vhd" $_VHDMod ] \
      [ list "../src/hdd/hdd_vm_prj_cfg.vhd" $_VHDPkg ] \
      [ list "../src/hdd/hdd_vm_main.vhd" $_VHDMod ] \
      [ list "../../ucf/hdd_vm_main.ucf" "hdd_vm_main" ] \
      ...
      [ list "../src/core_gen/hdd_bufi.vhd" $_VHDMod ] \
