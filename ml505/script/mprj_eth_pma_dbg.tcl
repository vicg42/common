...
set _usrdef_design "ml505_eth_pma_dbg"
...
set _usrdef_ucf_filepath "..\ucf\eth_pma_dbg.ucf"
...
set _projects [ list \
  [ list \
    $_usrdef_xilinx_family $_usrdef_device $_usrdef_pkg $_usrdef_speed xrc5t1 [ list \
      ...
      [ list "../src/eth/eth_pma_prj_cfg.vhd" $_VHDPkg ] \
      [ list "../../../common/veresk_main.vhd" $_VHDMod ] \
      [ list "../../ucf/eth_pma_dbg.ucf" "veresk_main" ] \
      ...
      [ list "../src/veresk/mem_ctrl_pkg.vhd" $_VHDPkg ] \
      ...
      [ list "../src/core_gen/ethg_pma_core/example_design/transceiver/ethg_pma_core_v5_gtpwizard.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_pma_core/example_design/transceiver/ethg_pma_core_transceiver_A.vhd" $_VHDMod ] \
      ...
      [ list "../src/eth/ethg_pma_core_v5_gtpwizard_tile_2G.vhd" $_VHDMod ] \
      [ list "../src/eth/ethg_pma.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/sync_block.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/clk_pack.vhd" $_VHDPkg ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/clk_half.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/tx_clk_gen.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/reset_sync.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/fifo/tx_client_fifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/fifo/rx_client_fifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/fifo/ten_100_1g_eth_fifo.vhd" $_VHDMod ] \
      [ list "../src/core_gen/ethg_mac_core/example_design/ethg_mac_core_locallink.vhd" $_VHDMod ] \
      [ list "../src/eth/ethg_mac_gmii_if.vhd" $_VHDMod ] \
      [ list "../src/eth/ethg_mac_core_block.vhd" $_VHDMod ] \
      [ list "../src/eth/ethg_mac.vhd" $_VHDMod ] \
      [ list "../src/eth/eth_pma_phypin_pkg.vhd" $_VHDPkg ] \
      [ list "../src/eth/eth_pma_phy.vhd" $_VHDPkg ] \
      [ list "../src/eth/clocks.vhd" $_VHDMod ] \
      [ list "../src/eth/clocks_pkg.vhd" $_VHDPkg ] \
