...
set _usrdef_design "ml505_veresk_rgmii"
set _usrdef_entity "veresk_rgmii_main"
set _usrdef_xilinx_family "virtex5"
set _usrdef_chip_family "v5lxt"
set _usrdef_device "5vlx50t"
set _usrdef_speed  1
set _usrdef_pkg    "ff1136"
set _usrdef_ucf_filename "veresk_rgmii_main"
set _usrdef_ucf_filepath "..\ucf\veresk_rgmii_main.ucf"
...
set _projects [ list \
  [ list \
    $_usrdef_xilinx_family $_usrdef_device $_usrdef_pkg $_usrdef_speed xrc5t1 [ list \
      ...
      [ list "../src/veresk/veresk_rgmii_prj_cfg.vhd" $_VHDPkg ] \
      [ list "../src/veresk/veresk_rgmii_main.vhd" $_VHDMod ] \
      [ list "../../ucf/veresk_rgmii_main.ucf" "veresk_rgmii_main" ] \
      ...
      [ list "../src/veresk/eth/eth_phypin_pkg_rgmii.vhd" $_VHDPkg ] \
