...
for /R  %%f in ( core_gen\mem_ctrl_core_axi\docs core_gen\mem_ctrl_core_axi\simulation  core_gen\mem_ctrl_core_axi\implement core_gen\mem_ctrl_core_axi\example_design) do rmdir /s /q "%%f"
for /R  %%f in ( core_gen\mem_ctrl_core_axi\*.txt ) do del "%%f"
for /R  %%f in ( core_gen\mem_ctrl_core_axi\*.csv ) do del "%%f"
